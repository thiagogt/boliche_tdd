...
public class App 
{
    ...
    public static void defaultCase(){
        ...
        public static void errorCases(){
            ...
            System.out.println();
            System.out.println("Quadros Com Caracateres Somatoria Maior Que Limite Possivel Na Ultima Rodada, Segunda Jogada");
            casoExemplo(partida_7);

            System.out.println();
            System.out.println("Quadros Com Caracateres Somatoria Maior Que Limite Possivel Na Ultima Rodada, Terceira Jogada");
